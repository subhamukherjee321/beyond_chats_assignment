...
const MobileNavbar = () => {
  ...
  return (
    <div className="sticky top-0 z-10 bg-[#212121]">
      <nav
        className="flex items-center justify-between p-4 bg-[#212121]"
      >
      ...
      <div
        className={`text-lg font-semibold fixed inset-y-0 left-0 w-64 bg-[#212121] text-white transform ${
          isDrawerOpen ? "translate-x-0" : "-translate-x-full"
        } transition-transform duration-300 ease-in-out shadow-lg z-50`}
      >
        <div className="bg-[#233040] p-4">
